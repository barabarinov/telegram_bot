...
TRANSLATES = {
    ...
    ONCE_MESSAGE: {
        UK: (
            "🙏🏼🫶🏼🇺🇦 Слава Україні! Дякую, що використовуєте Wallet-Tracker для підрахунку своїх доходів та витрат! "
            "Кожного для ми робимо усе можливе, аби бот ставав дедалі краще. "
            "Якщо ви бажаєте підтримати розробника, "
            "ви можете це зробити за допомогою переказу на картку по Україні 💳:"
        ),
        RU: (
            "🙏🏼🫶🏼🇺🇦 Спасибо, что используете Wallet-Tracker для подсчета своих доходов и расходов! "
            "Каждый день мы делаем все возможное, чтобы бот становился все лучше. "
            "Если вы желает поддержать разработчика, "
            "вы можете это сделать с помощью перевода на карту по Украине 💳:"
        ),
        EN: (
            "🙏🏼🫶🏼🇺🇦 Glory to Ukraine! Thank you for using Wallet-Tracker to keep track of your income and expenses!"
            "Every day we do our best to make the bot better and better. "
            "If you want to support a developer, "
